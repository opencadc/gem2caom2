...
LOOKUP = {
    ...
    'N20200103S0434': ['GN-CAL20200104-13-001', em.Inst.NIFS, 'GN-CAL20200104'],
    # NIRI
    ...
    'rS20060306S0090': ['GS-2005B-Q-10-63-003', em.Inst.TRECS,
                        'GS-2005B-Q-10'],
    ...
    'N20070819S0339_dark': ['GN-2007B-Q-107-150-004-DARK', em.Inst.GMOS,
                            'GN-2007B-Q-107'],
    'N20110927S0170_fringe': ['GN-CAL20110927-900-170', em.Inst.GMOS,
                              'GN-CAL20110927'],
    ...
    'S20131007S0067_fringe': ['GS-CAL20131007-900-067', em.Inst.GMOS,
                              'GS-CAL20131007'],
