...
#     }
#
#     observation_type = om.get('observation_type')
#     mode = om.get('mode')
#     if observation_type == 'DARK' or 'blank' in om.get('filter_name'):
#         metadata['energy'] = False
#         return metadata
#
#     # Determine energy metadata for the plane.
...
#         reference_wavelength = om.get('central_wavelength')
#         nrgdim = int(niri_metadata['naxis2'] / bin_y)
#
#         # Ignore energy information if value of 'central_wavelength' = 0.0
#         if reference_wavelength == 0.0 or observation_type == 'BIAS':
#             metadata['energy'] = False
#             return metadata
#
#         # if 'focus' in fpmask:
